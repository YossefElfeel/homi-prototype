...
export const accountEn: typeof accountDe = {
  ...
  subscription: {
    ...
    commitment: 'Minimum term until',
    nextCharge: 'Next charge',
    skipTitle: 'Skip a visit',
    skipBody: '{used} of {free} free changes used this month.',
    skipAction: 'Skip the next visit',
    skipBlocked:
      'The free change for this month is used up. A further skip will be charged.',
    ...
    cancelPending: 'Cancellation requested on {date}. We have been in touch.',
    emptyTitle: 'No active plan',
    emptyBody:
      'A plan pays off from about two jobs a month — a fixed team and a discount on every visit.',
