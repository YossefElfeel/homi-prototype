...
export const offerEn: typeof offerDe = {
  ...
  contract: {
    ...
    partiesHeading: 'The parties',
    contractor: 'Contractor',
    client: 'Client',
    serviceHeading: 'Service and date',
    serviceLabel: 'Service',
    addressLabel: 'Address',
    dateLabel: 'Date',
    dateOpen: 'Still open — set before payment',
    durationLabel: 'Planned duration',
    hours: '{n} h',
    priceHeading: 'Payment',
    discount: 'Discount',
    subtotal: 'Subtotal',
    total: 'Total',
    priceNote: 'Homivaro is not VAT registered. The amount shown is final.',
  },

  sign: {
    title: 'Sign the agreement',
    lead: 'Homivaro has already signed. Your signature closes the agreement.',
    ...
    confirm: 'I have read the agreement and accept it.',
    continue: 'Continue to payment',
    required: 'Please sign to continue.',
    documentTitle: 'The agreement',
    documentHint: 'The whole text is here — scroll to read it.',
    signaturesTitle: 'Signatures',
    companyCaption: 'For Homivaro',
    customerCaption: 'Client',
    companyPending: 'Applied when the quote is sent',
    customerPending: 'Your signature is still missing',
  },
