...
export const adminEn: typeof adminDe = {
  ...
  booking: {
    ...
    warn_clash: '{name} already has another job at the same time.',
    warn_skill: '{name} is not cleared for this service.',
    warn_region: 'This address is outside the area {name} works.',
    warn_inactive: '{name} is marked inactive.',
    hoursCorrect: 'Correct the hours',
    hoursAdd: 'Record the hours',
    hoursFieldLabel: 'Hours worked — {name}',
    hoursFieldHint:
      'The office’s own correction. The history then says it came from the office rather than from the person on the job.',
    hoursInvalid: 'Between 0.5 and {max} hours.',
    hoursSave: 'Save the hours',
    hoursSaved: 'Hours saved.',
    approveHours: 'Reported: {worked} hrs — {planned} hrs were planned.',
    approveNoHours: 'No time was reported.',
    customerTitle: 'Customer',
    propertyTitle: 'Property',
    accessTitle: 'Access',
    amountTitle: 'Amount',
    ...
    approveBody:
      'The job is checked out. The time reported is below, with the difference against the plan beside it. Approving makes the job billable — what an overrun costs is your decision on the invoice.',
