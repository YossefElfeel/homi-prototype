...
export const adminContentEn: typeof adminContentDe = {
  ...
  website: {
    title: 'Website text',
    lead: 'Every word on the website, grouped by page and editable per language.',

    staticNote:
      'The marketing pages are built at deploy time. What you write here is the text of the next version of the website — not the text a visitor is reading now. The request flow and the panel pick it up immediately.',
    exportAction: 'Export changes',
    exportEmpty: 'There is nothing to export yet.',
    exportDone: 'Downloaded a file with {n} text changes.',

    search: 'Search text',
    searchPlaceholder: 'A word, a page or a key',
    filterGroup: 'Area',
    filterAll: 'all',
    filterState: 'State',
    filterEdited: 'edited',
    filterGaps: 'translation missing',

    groupServices: 'Service pages',
    groupPages: 'Pages',
    groupLegal: 'Legal',
    groupFlows: 'Journeys',
    groupSystem: 'Everywhere',
    ...
    surfaces: {
      page: {
        ...
        about: 'About us',
        contact: 'Contact',
        regionsIndex: 'Service areas — index',
        region: 'Region page (template)',
        bau: 'Construction',
        careers: 'Jobs & application',
        thanks: 'Thank-you page',
        legalFrame: 'Legal — frame',
      },
      flow: {
        booking: 'Request flow',
        offer: 'Quote (customer view)',
        account: 'Customer account',
        field: 'Field app',
      },
      system: {
        words: 'Buttons & common words',
    ...
    colFields: 'Blocks',
    colEdited: 'Edited',
    colGaps: 'Missing in {locale}',

    rowOpen: 'Edit text',
    rowView: 'View on the website',

    emptyTitle: 'No text found',
    emptyBody: 'Nothing matches «{query}». Try a word from the text itself — the search reads the content, not just the names.',

    missingCopyTitle: '{n} live services with no page text',
    missingCopyBody:
      'These services are on sale and have nothing that could go on their page: {names}. Until the lead paragraph is written they get no page of their own at the next deploy.',
    missingCopyAction: 'Write it',

    back: 'Back to website text',
    detailLead: 'German is the market language and carries anything not translated (§20.6).',
    localeTab: 'Language',
    sourceEdited: 'edited',
    sourceDefault: 'as shipped',
    sourceFallback: 'showing German',
    sourceMissing: 'empty',
    fallbackHint:
      'Nothing is written for this language. The page renders the German text — which makes it look finished without being translated.',

    reset: 'Reset',
    resetLocale: 'Reset this language',
    resetAll: 'Reset every language',
    resetDone: 'Restored the text as shipped.',
    resetTitle: 'Reset this text?',
    resetBody:
      'The block goes back to what shipped with the current version of the website. Your change is gone afterwards.',
    ...
    moveUp: 'Move up',
    moveDown: 'Move down',
    listEmpty: 'No lines yet. The list does not appear on the page while it is empty.',

    pairQuestion: 'Question',
    pairAnswer: 'Answer',
    pairTitle: 'Title',
    pairBody: 'Text',
    pairName: 'Name and place',
    pairQuote: 'Quote',
    pairPrice: 'Price',
    pairFigure: 'Figure',
    pairCaption: 'Caption',
    headlineLead: 'First half',
    headlineAccent: 'Second half (red)',
    headlineHint: 'A large two-colour heading. Each line breaks where it breaks here.',
    ...
    words: {
      ...
      meta: 'Search engines',
      metaTitle: 'Title for search engines',
      ...
      emptyBody: 'Empty state — text',
      emptyAction: 'Empty state — button',
      searchEmptyTitle: 'No matches — title',
      searchEmptyBody: 'No matches — text',
      filterEmptyTitle: 'No results — title',
      filterEmptyBody: 'No results — text',
      filterAll: 'Filter «all»',
      filterReset: 'Reset filters',
      missingTitle: 'Missing — title',
      missingBody: 'Missing — text',
      rowOpen: 'Open row',
      nextTitle: 'What happens next',
      accessTitle: 'Access',
      faqTitle: 'Frequently asked',
      faqLines: 'Heading «Frequently asked»',
      name: 'Name',
    ...
    fields: {
      ...
      home: {
        heroHeadline: 'Masthead headline',
        heroSub: 'Subtitle in the masthead',
        heroTags: 'Tags in the masthead',
        heroBadge: 'Badge over the image',
        stats: 'Four figures',
        servicesHeadline: 'Heading «Services»',
        servicesBody: 'Text «Services»',
        servicesItems: 'Service tiles',
        promisesHeadline: 'Heading «Promises»',
        promises: 'Promises',
        stepsHeadline: 'Heading «How it works»',
        steps: 'Four steps',
        coverageHeadline: 'Heading «Service area»',
        coverageBody: 'Text «Service area»',
        plansHeadline: 'Heading «Plans»',
        plansDiscount: 'Discount label on the plan cards',
        ctaHeadline: 'Heading in the call-to-action band',
        ctaBody: 'Text in the call-to-action band',
        testimonialsEyebrow: 'Eyebrow above «Testimonials»',
        testimonialsHeadline: 'Heading «Testimonials»',
        testimonialsRating: 'Rating line',
        testimonials: 'Testimonials',
        testimonialsCount: 'Large figure above the testimonials',
        testimonialsStars: 'Stars label (for screen readers)',
      },
      chrome: {
        nav: 'Menu items',
        tagline: 'Footer strapline',
        footerServices: 'Footer — services',
        footerCompany: 'Footer — company',
        footerLegal: 'Footer — legal',
        hours: 'Opening hours',
        copyright: 'Copyright line',
        footerServicesTitle: 'Footer — «Services» heading',
        footerCompanyTitle: 'Footer — «Company» heading',
        footerSupportTitle: 'Footer — «Support» heading',
        footerSocial: 'Footer — «Social media» heading',
        madeIn: 'Origin line',
        phone: 'Phone number',
    ...
    interfaceNote:
      'These words are not on one page, they are everywhere: buttons, status labels, error messages. One word here changes every screen that uses it.',
  },
