...
export const siteDe = {
  ...
  plans: {
    ...
    lead: 'Ein fester Rhythmus, ein fester Rabatt. Den Termin schlagen wir vor, verschieben können Sie ihn jederzeit.',
    recommended: 'Für die meisten Haushalte',
    compareTitle: 'Im Vergleich',
    rowFrequency: 'Rhythmus',
    rowDiscount: 'Rabatt',
    rowPriority: 'Terminvorrang',
    rowSameTeam: 'Dieselbe Person',
    rowCommitment: 'Mindestlaufzeit',
    rowNotice: 'Kündigungsfrist',
    rowSkips: 'Einsätze aussetzen',
    freqBasic: 'Alle zwei Wochen',
    freqPremium: 'Wöchentlich',
    freqVip: 'Zweimal wöchentlich',
    priorityYes: 'Ja',
    priorityNo: '—',
    sameTeamAlways: 'Wenn immer möglich',
    commitment: '12 Monate',
    notice: '1 Monat',
    skips: '1× pro Monat kostenlos',
    commitmentNoticeTitle: 'Zur Mindestlaufzeit',
    commitmentNoticeBody:
      'Das Abo läuft zwölf Monate. Wir sagen das hier, weil Sie es vor dem Abschluss wissen sollen und nicht im Kleingedruckten finden.',
    faqTitle: 'Fragen zum Abo',
    q1: 'Wie kündige ich?',
    a1: 'Über Ihren Kundenbereich, mit einem Monat Frist. Läuft die Mindestlaufzeit noch, zeigen wir Ihnen die Bedingungen vor dem Bestätigen und melden uns persönlich.',
    ...
    q3: 'Kann ich das Abo wechseln?',
    a3: 'Ein Upgrade gilt sofort. Ein Downgrade gilt ab der nächsten Abrechnungsperiode.',
    cta: 'Abo starten',
  },
