...
export const TRACKS: Track[] = [
  ...
  },
  {
    ...
    screens: [
      todo('23', 'Offerte', 'Quote'),
      todo('24', 'Optionale Positionen', 'Optional items'),
      todo('25', 'Termin wählen', 'Pick a slot', ['no availability']),
      todo('26', 'Unterschrift', 'E-signature'),
      todo('27', 'Zahlung', 'Payment', ['TWINT', 'card', 'wallet', 'processing']),
      todo('28', 'Buchung bestätigt', 'Booking confirmed'),
      todo('29', 'Änderung anfragen', 'Request a change'),
      todo('30', 'Offerte abgelaufen', 'Quote expired'),
      todo('31', 'Zahlung fehlgeschlagen', 'Payment failed', ['hold timer running', 'hold expired']),
    ],
  },
  {
    id: 'account',
  ...
  },
  {
    ...
    screens: [
      todo('50', 'Anmelden', 'Sign in', ['error']),
      todo('51', 'Start', 'Dashboard', ['every block empty']),
      todo('52', 'Anfragen', 'Requests', ['empty', 'no search result']),
      todo('53', 'Anfrage-Detail', 'Request detail', ['codes hidden', 'codes revealed']),
      todo('54', 'Offerte erstellen', 'Quote builder', ['draft', 'sending', 'sent'], 'The screen the owner lives in. Target: send a quote in ≤4 interactions'),
      todo('55', 'Vorschau & senden', 'Preview & send'),
      todo('56', 'Anfrage ablehnen', 'Decline request'),
      todo('57', 'Offerten', 'Quotes', ['empty']),
      todo('58', 'Kalender — Tag', 'Calendar — day', ['no jobs']),
      todo('59', 'Kalender — Woche', 'Calendar — week'),
      todo('60', 'Kalender — Monat', 'Calendar — month', ['closure period']),
      todo('61', 'Agenda', 'Agenda list', ['empty']),
      todo('62', 'Routenkarte', 'Route map', ['travel conflict']),
      todo('63', 'Buchungs-Detail', 'Booking detail'),
