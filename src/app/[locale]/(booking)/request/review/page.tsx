...
export default function ReviewStep() {
  ...
  function submit() {
    ...
    window.setTimeout(() => {
      ...
      router.push(`/request/sent?ref=${result.reference}`);
    }, 800);
  }
  ...
  return (
    <BookingStep step="review" title={t('title')} lead={t('lead')} canContinue>
      <dl className="divide-y divide-line-subtle border-y border-line-subtle">
        ...
        <Row label={t('sectionProperty')} href="/request/property" edit={t('edit')}>
        ...
        {draft.pickup && (
          <Row label={pt('pickupTitle')} href="/request/property" edit={t('edit')}>
        ...
        {showAddOns && (
          <Row label={t('sectionAddons')} href="/request/extras" edit={t('edit')}>
            {chosen.length ? chosen.map((a) => a.name[locale]).join(', ') : t('noAddons')}
          </Row>
        )}
        <Row label={t('sectionAccess')} href="/request/access" edit={t('edit')}>
          {accessLabel}
        </Row>
        <Row label={t('sectionTime')} href="/request/slot" edit={t('edit')}>
          {timeLabel}
        </Row>
        <Row label={t('sectionPhotos')} href="/request/photos" edit={t('edit')}>
          {draft.photos.length ? (
        ...
        <Row label={t('sectionContact')} href="/request/contact" edit={t('edit')}>
          <span className="block">
