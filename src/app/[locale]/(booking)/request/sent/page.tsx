 ...
 * those still got sent; the coverage check on `/request/property` stops them
    ...
    <div className="mx-auto max-w-2xl px-gutter py-section">
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        {/*
          ...
          entry to activation — /activate-account had no inbound link at all,
          and this screen previously offered only WhatsApp and the homepage.
        */}
        <Button asChild>
          <Link href="/activate-account">{t('activate')}</Link>
        </Button>
