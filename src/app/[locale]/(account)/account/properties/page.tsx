 ...
 *
 * It is the same table the office reads on /admin/properties now, minus the two
...
export default function AccountPropertiesPage() {
  ...
  const columns: Column<Property>[] = [
    ...
    },
    {
       ...
       * could not answer. The office has had the column since /admin/properties
  ...
  return (
    <>
      ...
      <DataView
        ...
        columns={columns}
        getKey={(p) => p.id}
        onSelect={(p) => router.push(`/account/properties/${p.id}`)}
        caption={t('title')}
        rowActions={(p) => (
          <RowActions>
