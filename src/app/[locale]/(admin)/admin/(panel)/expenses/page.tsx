...
export default function ExpensesPage() {
  ...
  const columns: Column<Expense>[] = [
    ...
    },
    {
      ...
      cell: (e) => {
        ...
        return (
          <RecordLink href={`/admin/bookings/${e.bookingId}`} numeric>
            {reference}
          </RecordLink>
        );
      },
  ...
  function menu(expense: Expense) {
    ...
    return (
      <RowActions>
        <RowAction href={`/admin/expenses/${expense.id}`} label={t('rowOpen')}>
          <ActionIcon.open aria-hidden />
        </RowAction>
        <RowAction href={`/admin/expenses/${expense.id}`} label={t('rowEdit')}>
        ...
        actions={
          <>
            ...
            <Button asChild variant="secondary">
              <Link href="/admin/expenses/hours">
