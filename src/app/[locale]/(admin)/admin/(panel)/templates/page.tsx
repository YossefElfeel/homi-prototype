 ...
 *
 * Editing moved to `/admin/templates/[id]`, following the coupon screens. The
...
export default function AdminTemplatesPage() {
  ...
  const menu = (x: MessageTemplate) => (
    <RowActions>
      ...
      <RowAction label={t('editAction')} href={`/admin/templates/${x.id}`}>
  ...
  return (
    <div>
      ...
      <DataView
        ...
        getKey={(x) => x.id}
        rowActions={menu}
        onSelect={(x) => router.push(`/admin/templates/${x.id}`)}
        caption={t('title')}
        empty={
          <EmptyState
            title={t('emptyTitle')}
