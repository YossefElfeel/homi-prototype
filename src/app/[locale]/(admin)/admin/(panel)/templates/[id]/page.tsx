 ...
 *
 * `/admin/templates/new` opens the same form empty, following the coupon
    ...
    return (
      <div>
        <PageHeader
          ...
          back={{ href: '/admin/templates', label: t('back') }}
        />
        ...
        <div className="space-y-app-section">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button asChild variant="ghost">
              <Link href="/admin/templates">{listT('deleteCancel')}</Link>
            </Button>
          </div>
        </div>
