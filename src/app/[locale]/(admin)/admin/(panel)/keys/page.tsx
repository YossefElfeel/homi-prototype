    ...
    return (
      <div className="max-w-2xl">
        ...
        <Button asChild variant="secondary" className="mt-6">
          <Link href="/admin/settings?tab=fees">{t('lockedAction')}</Link>
        </Button>
  ...
  return (
    <div>
      ...
      <DataView
         ...
         * was the sidebar, /admin/properties, and a search for a label read off
         * this table.
         */
        rowActions={(k) => (
          <RowActions>
            <RowAction href={`/admin/properties/${k.propertyId}`} label={t('rowProperty')}>
