...
export default function RequestsPage() {
   ...
   * tabs put them in the same control, the way /admin/customers already does.
   */
        ...
        return (
          <RowActions>
            {draft ? (
              <>
                <RowAction
                  href={`/admin/requests/new?draft=${r.id}`}
                  label={t('rowContinue')}
                >
              ...
              <>
                <RowAction href={`/admin/requests/${r.id}`} label={t('rowOpen')}>
