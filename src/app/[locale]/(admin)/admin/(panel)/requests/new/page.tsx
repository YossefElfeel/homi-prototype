...
export default function NewRequestPage() {
  ...
  function save(thenQuote: boolean) {
    ...
    if (draft) {
      ...
      router.push(
        thenQuote ? `/admin/requests/${draft.id}/quote` : `/admin/requests/${draft.id}`,
      );
      return;
    }
    ...
    router.push(
      thenQuote ? `/admin/requests/${result.id}/quote` : `/admin/requests/${result.id}`,
    );
  }
  ...
  return (
    <div>
      <PageHeader
        ...
        back={{ href: '/admin/requests', label: t('back') }}
        meta={
          draft && (
            ...
            >
              ...
              {savedProperty && (
                <Button asChild variant="secondary" size="sm" className="mt-4">
                  <Link href={`/admin/properties/${savedProperty.id}`}>
              ...
              <div className="mt-5 space-y-2 border-t border-line-subtle pt-4">
                ...
                */}
                ...
                <Button asChild block variant="ghost">
                  <Link href="/admin/requests">{t('cancel')}</Link>
                </Button>
              </div>
            </Card>
          </aside>
