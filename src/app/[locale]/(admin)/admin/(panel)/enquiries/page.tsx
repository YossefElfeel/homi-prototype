 ...
 *
 * The form validated six fields, showed a spinner and pushed to /thank-you, and
 * the message existed for 900 milliseconds in a closure. /thank-you told the
  ...
  const visible = useMemo(() => {
    ...
    return enquiries
      ...
      /* Oldest first in the new tab, newest first everywhere else. An inbox is
         ...
         break the promise on /contact, and sorting newest-first buries it. */
      .slice()
      .sort((a, b) =>
        tab === 'new'
                ...
                {visible.map((enquiry) => {
                  ...
                  return (
                    <li key={enquiry.id} className="surface-card p-5">
                      ...
                      {/* The promise on /contact is a number in settings, so
                      ...
                      {enquiry.customerId && (
                        <p className="mt-3 text-sm">
                          <Link
                            href={`/admin/customers/${enquiry.customerId}`}
