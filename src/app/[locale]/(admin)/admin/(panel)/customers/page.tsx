...
export default function CustomersPage() {
  ...
  const list = (
    <DataView
      ...
      rowActions={(c) => (
        <RowActions>
          <RowAction href={`/admin/customers/${c.id}`} label={t('rowView')}>
            <ActionIcon.open aria-hidden />
          </RowAction>
          <RowAction href={`/admin/customers/${c.id}/edit`} label={t('rowEdit')}>
        ...
        */}
        <Toolbar
          ...
          /*
            ...
            screen and /admin/requests — the same list, one row of tabs and one
