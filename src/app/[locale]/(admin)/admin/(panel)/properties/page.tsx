  ...
  return (
    <div>
      ...
      <DataView
        ...
        columns={columns}
        getKey={(p) => p.id}
        onSelect={(p) => router.push(`/admin/properties/${p.id}`)}
        caption={t('title')}
        openLabel={t('rowView')}
        /*
        ...
        rowActions={(p) => {
          ...
          return (
            <RowActions>
              <RowAction href={`/admin/properties/${p.id}`} label={t('rowView')}>
                <ActionIcon.open aria-hidden />
              </RowAction>
              <RowAction href={`/admin/properties/${p.id}/edit`} label={t('rowEdit')}>
