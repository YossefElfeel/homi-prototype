 ...
 * /admin/bookings has been printing a "Manuell" source label since it was
  ...
  return (
    <div>
      <PageHeader
        title={t('title')}
        lead={t('lead')}
        back={{ href: '/admin/calendar', label: t('back') }}
      />
        ...
        <EmptyState
          ...
          action={
            <Button asChild variant="secondary">
              <Link href="/admin/customers/new">{t('noCustomersAction')}</Link>
            </Button>
          }
        />
      ) : (
          ...
          */}
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button asChild variant="ghost">
              <Link href="/admin/calendar">{t('cancel')}</Link>
            </Button>
          </div>
        </form>
      )}
