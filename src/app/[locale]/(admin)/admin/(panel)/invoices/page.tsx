...
export default function InvoicesPage() {
  ...
  function menu(invoice: Invoice) {
    ...
    return (
      <RowActions>
        <RowAction href={`/admin/invoices/${invoice.id}`} label={t('rowOpen')}>
          <ActionIcon.open aria-hidden />
        </RowAction>
        {canEdit ? (
          <RowAction href={`/admin/invoices/${invoice.id}`} label={t('rowEdit')}>
        ...
        {canPay && (
          ...
          <RowAction href={`/admin/invoices/${invoice.id}`} label={invoiceT('markPaid')}>
  ...
  return (
    <div>
      ...
      <DataView
        ...
        columns={columns}
        getKey={(i) => i.id}
        onSelect={(i) => router.push(`/admin/invoices/${i.id}`)}
        caption={t('title')}
        openLabel={t('rowOpen')}
        rowActions={menu}
