...
export default function AdminServicesPage() {
      ...
      .filter((s) =>
        q
          ? /* The slug is in here because it is the URL, and «welche Leistung
               ist /services/umzugsreinigung» is a question the office asks
  ...
  function menu(service: Service) {
    return (
      <RowActions>
        <RowAction
          href={`/admin/services/${service.slug}/details`}
          label={t('rowOpen')}
        >
          <ActionIcon.open aria-hidden />
        </RowAction>
        <RowAction href={`/admin/services/${service.slug}`} label={t('rowEdit')}>
  ...
  return (
    <div>
      ...
      <DataView
        ...
        onSelect={(s) => router.push(`/admin/services/${s.slug}/details`)}
        caption={t('title')}
        openLabel={t('rowOpen')}
        rowActions={menu}
        empty={
